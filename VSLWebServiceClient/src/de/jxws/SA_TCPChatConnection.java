...
public class SA_TCPChatConnection {
	...
	/**
	 * macht dan JFrame wieder sichbar.
	 */
	...
	* 
	*/
	public SA_TCPChatConnection(Socket connectionSocket) {
		line = null;
		isConnected = false;
		inFromClient=null;
		outToClient=null;
